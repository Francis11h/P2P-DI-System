...
public class Peer {
    ...
    public Peer(String hostName, Integer port) {
        ...
        this.cookie = Peer.cookie_count;
        this.isActive = true;
        this.TTL = 7200;
        this.port = port;
        this.registered_count = 1;
        this.last_registered = new SimpleDateFormat("yyyy-MM-dd kk:mm:ss").format(new java.util.Date().getTime());
        Peer.cookie_count += 1;
    }
    ...
    public long getTimeDiff(String paramTime) {
        // get system time
...
//            System.out.println("time difference is " + difference / 1000 + "s");
